...
#define MATERIAL_PLASMAGLASS		"plasmaglass"
#define MATERIAL_PLASMA_RGLASS		"plasmarglass"
...
#define MATERIAL_BANANIUM			"bananium"
#define MATERIAL_ENRICHED_URANIUM	"enriched_uranium"
#define MATERIAL_ADAMANTINE			"adamantine"
#define MATERIAL_MYTHRIL			"mythril"