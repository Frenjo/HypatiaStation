...
/mob/living/simple/gutlunch/Life()
	. = ..()
	if(stat == CONSCIOUS)
		nutrient_sac.generate_milk()

/mob/living/simple/gutlunch/attack_by(obj/item/I, mob/user)
...
/mob/living/simple/gutlunch/gubbuck
	name = "gubbuck"
	gender = MALE

/mob/living/simple/gutlunch/gubbuck/New()
	. = ..()
...
/mob/living/simple/gutlunch/guthen
	name = "guthen"
	gender = FEMALE

/mob/living/simple/gutlunch/guthen/New()
	. = ..()
