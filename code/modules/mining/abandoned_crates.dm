...
/obj/structure/closet/crate/secure/loot/attack_tool(obj/item/tool, mob/user)
	if(locked && ismultitool(tool))
...
/obj/structure/closet/crate/secure/loot/proc/create_loot()
	var/loot = rand(1, 30)
	switch(loot)
		if(1)
			starts_with = list(
