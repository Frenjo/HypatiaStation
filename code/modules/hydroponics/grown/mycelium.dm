 ...
 * Reishi
 */
/obj/item/reagent_holder/food/snacks/grown/mushroom/reishi
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/amanita/attackby(obj/item/O, mob/user)
	. = ..()
	if(istype(O, /obj/item/plant_analyser))
 ...
 * Destroying Angel
 */
/obj/item/reagent_holder/food/snacks/grown/mushroom/angel
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/angel/initialise()
	. = ..()
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/angel/attackby(obj/item/O, mob/user)
	. = ..()
	if(istype(O, /obj/item/plant_analyser))
		to_chat(user, SPAN_INFO("- Amatoxins: <i>[reagents.get_reagent_amount("amatoxin")]%</i>"))
		to_chat(user, SPAN_INFO("- Psilocybin: <i>[reagents.get_reagent_amount("psilocybin")]%</i>"))
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/libertycap/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 50), 1))
	reagents.add_reagent("psilocybin", 3 + round(potency / 5, 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)

/obj/item/reagent_holder/food/snacks/grown/mushroom/libertycap/attackby(obj/item/O, mob/user)
	. = ..()
	if(istype(O, /obj/item/plant_analyser))
		to_chat(user, SPAN_INFO("- Psilocybin: <i>[reagents.get_reagent_amount("psilocybin")]%</i>"))
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/chanterelle/initialise()
	. = ..()
 ...
 * Glowshroom
 */
/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom/initialise()
	. = ..()
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom/attack_self(mob/user)
	if(isspace(user.loc))
		return
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom/Destroy()
	if(ismob(loc))
		loc.set_light(round(loc.luminosity - potency / 10, 1))
	return ..()

/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom/pickup(mob/user)
	set_light(0)
	user.set_light(round(user.luminosity + (potency / 10), 1))

/obj/item/reagent_holder/food/snacks/grown/mushroom/glowshroom/dropped(mob/user)
	user.set_light(round(user.luminosity - (potency / 10), 1))
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/plumphelmet/initialise()
	. = ..()
 ...
 * Walking Mushroom
 */
/obj/item/reagent_holder/food/snacks/grown/mushroom/walkingmushroom
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/walkingmushroom/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 2 + round((potency / 10), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)
	if(ismob(loc))
...
/obj/item/reagent_holder/food/snacks/grown/mushroom/walkingmushroom/attack_self(mob/user)
	if(isspace(user.loc))
		return
