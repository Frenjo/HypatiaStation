...
/obj/item/reagent_holder/food/snacks/grown/chili/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 25), 1))
	reagents.add_reagent("capsaicin", 3 + round(potency / 5, 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)

/obj/item/reagent_holder/food/snacks/grown/chili/attackby(obj/item/O, mob/user)
	. = ..()
...
/obj/item/reagent_holder/food/snacks/grown/icepepper/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 50), 1))
	reagents.add_reagent("frostoil", 3 + round(potency / 5, 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)

/obj/item/reagent_holder/food/snacks/grown/icepepper/attackby(obj/item/O, mob/user)
	. = ..()
	if(istype(O, /obj/item/plant_analyser))
 ...
 * Grape
 */
/obj/item/reagent_holder/food/snacks/grown/grapes
...
/obj/item/reagent_holder/food/snacks/grown/grapes/initialise()
	. = ..()
 ...
 * Green Grape
 */
/obj/item/reagent_holder/food/snacks/grown/greengrapes
...
/obj/item/reagent_holder/food/snacks/grown/greengrapes/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 10), 1))
...
/obj/item/reagent_holder/food/snacks/grown/berries/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 10), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)
 ...
 * Glow Berry
 */
/obj/item/reagent_holder/food/snacks/grown/glowberries
...
/obj/item/reagent_holder/food/snacks/grown/glowberries/initialise()
	. = ..()
	reagents.add_reagent("nutriment", round((potency / 10), 1))
	reagents.add_reagent("uranium", 3 + round(potency / 5, 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)

/obj/item/reagent_holder/food/snacks/grown/glowberries/Destroy()
	if(ismob(loc))
		loc.set_light(round(loc.luminosity - potency / 5, 1))
	return ..()

/obj/item/reagent_holder/food/snacks/grown/glowberries/pickup(mob/user)
	src.set_light(0)
	user.set_light(round(user.luminosity + (potency / 5), 1))

/obj/item/reagent_holder/food/snacks/grown/glowberries/dropped(mob/user)
	user.set_light(round(user.luminosity - (potency / 5), 1))
 ...
 * Poison Berry
 */
/obj/item/reagent_holder/food/snacks/grown/poisonberries
...
/obj/item/reagent_holder/food/snacks/grown/poisonberries/initialise()
	. = ..()
 ...
 * Death Berry
 */
/obj/item/reagent_holder/food/snacks/grown/deathberries
...
/obj/item/reagent_holder/food/snacks/grown/deathberries/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1)
...
/obj/item/reagent_holder/food/snacks/grown/eggplant/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 10), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)
...
/obj/item/reagent_holder/food/snacks/grown/apple/initialise()
	. = ..()
 ...
 * Poisoned Apple
 */
/obj/item/reagent_holder/food/snacks/grown/apple/poisoned
...
/obj/item/reagent_holder/food/snacks/grown/apple/poisoned/initialise()
	. = ..()
	reagents.maximum_volume = 20
...
/obj/item/reagent_holder/food/snacks/grown/goldapple/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 10), 1))
 ...
 * Watermelon
 */
/obj/item/reagent_holder/food/snacks/grown/watermelon
	...
	slice_path = /obj/item/reagent_holder/food/snacks/watermelonslice
	slices_num = 5

/obj/item/reagent_holder/food/snacks/grown/watermelon/initialise()
	. = ..()
...
/obj/item/reagent_holder/food/snacks/grown/pumpkin/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 6), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)

/obj/item/reagent_holder/food/snacks/grown/pumpkin/attackby(obj/item/W, mob/user)
	..()
...
/obj/item/reagent_holder/food/snacks/grown/lime/initialise()
	. = ..()
...
/obj/item/reagent_holder/food/snacks/grown/lemon/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 20), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)
...
/obj/item/reagent_holder/food/snacks/grown/orange/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 20), 1))
	bitesize = 1 + round(reagents.total_volume / 2, 1)
 ...
 * Cocoa Pod
 */
/obj/item/reagent_holder/food/snacks/grown/cocoapod
...
/obj/item/reagent_holder/food/snacks/grown/cocoapod/initialise()
	. = ..()
	reagents.add_reagent("nutriment", 1 + round((potency / 10), 1))
...
/obj/item/reagent_holder/food/snacks/grown/cherries/initialise()
	. = ..()
