...
/obj/item/spellbook/Topic(href, href_list)
	...
	if(loc == H || (in_range(src, H) && isturf(loc)))
		...
		if(href_list["spell_choice"])
			...
			/*
			*/
				var/list/available_spells = list(magicmissile = "Magic Missile", fireball = "Fireball", disintegrate = "Disintegrate", disabletech = "Disable Tech", \
												smoke = "Smoke", blind = "Blind", mindswap = "Mind Transfer", forcewall = "Forcewall", blink = "Blink", teleport = "Teleport", \
												mutate = "Mutate", etherealjaunt = "Ethereal Jaunt", knock = "Knock", horseman = "Curse of the Horseman", \
												summonguns = "Summon Guns", staffchange = "Staff of Change", mentalfocus = "Mental Focus", \
												soulstone = "Six Soul Stone Shards and the spell Artificer", armor = "Mastercrafted Armor Set", staffanimate = "Staff of Animation")
				var/already_knows = 0
