...
/obj/item/weapon/reagent_containers/pill/arithracaridine
	name = "Arithracaridine pill"
	// Should this be "Arithra-Caridine"? -Frenjo
	desc = "Used to treat severe radiation sickness."
	icon_state = "pill15"
	
/obj/item/weapon/reagent_containers/pill/arithracaridine/New()
	..()
...
/obj/item/weapon/reagent_containers/pill/stokaline
	name = "Stokaline pill"
	desc = "Used to provide essential nutrients in emergencies, or as a vitamin supplement."
	icon_state = "pill18"
	
/obj/item/weapon/reagent_containers/pill/stokaline/New()
	..()
