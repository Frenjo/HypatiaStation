			...
			for(var/P in Paths)
				...
				if(istype(Item,/obj/item/card/id))
					...
					for(var/obj/item/card/id/C in M)
						//default settings
						I.name = "[M.real_name]'s ID Card ([M.mind.job_alt_title ? M.mind.job_alt_title : M.mind.assigned_role])"
						...
						if(M.ckey == "fastler" && M.real_name == "Fastler Greay") //This is a Lifetime ID
							I.name = "[M.real_name]'s Lifetime ID Card ([M.mind.job_alt_title ? M.mind.job_alt_title : M.mind.assigned_role])"
						else if(M.ckey == "nerezza" && M.real_name == "Asher Spock") //This is an Odysseus Specialist ID
							I.name = "[M.real_name]'s Odysseus Specialist ID Card ([M.mind.job_alt_title ? M.mind.job_alt_title : M.mind.assigned_role])"
							...
							I.name = "[M.real_name]'s Technician ID ([M.mind.job_alt_title ? M.mind.job_alt_title : M.mind.assigned_role])"
