...
- Destructive Analyser: You can put hand-held objects into it and it'll analyse them for technological advancements but it destroys
...
Destructive Analyser. By themselves, they don't do a whole lot. However, they unlock Device Designs. This is the information used
