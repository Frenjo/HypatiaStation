...
/datum/design/mining/jackhammer
	...
	materials = list(/decl/material/steel = 2000, /decl/material/glass = 500, /decl/material/silver = 500)
...
/datum/design/mining/drill
	...
	build_type = DESIGN_TYPE_PROTOLATHE
	materials = list(/decl/material/steel = 6000, /decl/material/glass = 1000) //expensive, but no need for miners.
...
/datum/design/mining/plasmacutter
	...
	build_type = DESIGN_TYPE_PROTOLATHE
	materials = list(/decl/material/steel = 1500, /decl/material/glass = 500, /decl/material/gold = 500, /decl/material/plasma = 500)
	reliability_base = 79
