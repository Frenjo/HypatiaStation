...
/datum/design/autolathe/igniter
	...
	materials = list(/decl/material/plastic = 500, /decl/material/glass = 50)
	build_path = /obj/item/assembly/igniter

/datum/design/autolathe/signaler
	name = "Remote Signalling Device"
	req_tech = list(/decl/tech/magnets = 1)
	materials = list(/decl/material/plastic = 1000, /decl/material/glass = 200)
...
/datum/design/autolathe/proximity_sensor
	...
	req_tech = list(/decl/tech/magnets = 1)
	materials = list(/decl/material/plastic = 800, /decl/material/glass = 200)
...
/datum/design/autolathe/camera_assembly
	...
	materials = list(/decl/material/plastic = 700, /decl/material/glass = 300)
