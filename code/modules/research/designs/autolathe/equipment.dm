/datum/design/autolathe/welding_helmet
	name = "Welding Helmet"
	materials = list(/decl/material/plastic = 3000, /decl/material/glass = 1000)
	build_type = /obj/item/clothing/head/welding

/datum/design/autolathe/radio_headset
	name = "Radio Headset"
	materials = list(/decl/material/plastic = 75)
	build_type = /obj/item/radio/headset

/datum/design/autolathe/bounced_radio
	name = "Station Bounced Radio"
	materials = list(/decl/material/plastic = 75, /decl/material/glass = 25)
