...
/datum/design/stock_part/micro_mani
	...
	build_type = DESIGN_TYPE_PROTOLATHE | DESIGN_TYPE_AUTOLATHE
	materials = list(/decl/material/plastic = 30)
...
/datum/design/stock_part/basic_micro_laser
	...
	req_tech = list(/decl/tech/magnets = 1)
	build_type = DESIGN_TYPE_PROTOLATHE | DESIGN_TYPE_AUTOLATHE
	materials = list(/decl/material/plastic = 10, /decl/material/glass = 20)
...
/datum/design/stock_part/basic_matter_bin
	...
	build_type = DESIGN_TYPE_PROTOLATHE | DESIGN_TYPE_AUTOLATHE
	materials = list(/decl/material/plastic = 80)
...
/datum/design/stock_part/super_capacitor
	...
	reliability_base = 71
	materials = list(/decl/material/plastic = 50, /decl/material/glass = 50, /decl/material/gold = 20)
...
/datum/design/stock_part/phasic_scanning_module
	...
	materials = list(/decl/material/plastic = 50, /decl/material/glass = 20, /decl/material/silver = 10)
	reliability_base = 72
...
/datum/design/stock_part/ultra_micro_laser
	...
	materials = list(/decl/material/plastic = 10, /decl/material/glass = 20, /decl/material/uranium = 10)
	reliability_base = 70
...
/datum/design/stock_part/hyper_capacitor
	...
	reliability_base = 71
	materials = list(/decl/material/plastic = 50, /decl/material/glass = 50, /decl/material/silver = 20, /decl/material/gold = 20)
...
/datum/design/stock_part/hyperphasic_scanning_module
	...
	materials = list(/decl/material/plastic = 50, /decl/material/glass = 20, /decl/material/silver = 10, /decl/material/gold = 10)
	reliability_base = 72
...
/datum/design/stock_part/hyper_ultra_micro_laser
	...
	materials = list(/decl/material/plastic = 10, /decl/material/glass = 20, /decl/material/uranium = 10, /decl/material/plasma = 10)
	reliability_base = 70
...
/datum/design/stock_part/subspace_ansible
	...
	materials = list(/decl/material/plastic = 80, /decl/material/silver = 20)
...
/datum/design/stock_part/hyperwave_filter
	...
	materials = list(/decl/material/plastic = 40, /decl/material/silver = 10)
...
/datum/design/stock_part/subspace_amplifier
	...
	materials = list(/decl/material/plastic = 10, /decl/material/gold = 30, /decl/material/uranium = 15)
...
/datum/design/stock_part/subspace_treatment
	...
	materials = list(/decl/material/plastic = 10, /decl/material/silver = 20)
...
/datum/design/stock_part/subspace_analyser
	...
	req_tech = list(/decl/tech/materials = 4, /decl/tech/magnets = 4, /decl/tech/programming = 3, /decl/tech/bluespace = 2)
	materials = list(/decl/material/plastic = 10, /decl/material/gold = 15)
...
/datum/design/power_cell/basic
	...
	materials = list(/decl/material/steel = 750, /decl/material/glass = 50)
...
/datum/design/power_cell/high
	...
	build_type = DESIGN_TYPE_PROTOLATHE | DESIGN_TYPE_AUTOLATHE | DESIGN_TYPE_ROBOFAB | DESIGN_TYPE_MECHFAB
	materials = list(/decl/material/steel = 750, /decl/material/glass = 60)
...
/datum/design/power_cell/super
	...
	materials = list(/decl/material/steel = 750, /decl/material/glass = 70, /decl/material/silver = 100)
...
/datum/design/power_cell/hyper
	...
	reliability_base = 70
	build_type = DESIGN_TYPE_PROTOLATHE | DESIGN_TYPE_ROBOFAB | DESIGN_TYPE_MECHFAB
	materials = list(/decl/material/steel = 750, /decl/material/glass = 80, /decl/material/silver = 200, /decl/material/gold = 200)
