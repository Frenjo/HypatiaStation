...
/datum/design/circuit/ai_module/safeguard
	...
	req_tech = list(/decl/tech/materials = 4, /decl/tech/programming = 3) // Made of gold.
...
/datum/design/circuit/ai_module/onehuman
	...
	req_tech = list(/decl/tech/materials = 6, /decl/tech/programming = 4) // Made with diamonds!
...
/datum/design/circuit/ai_module/quarantine
	...
	req_tech = list(/decl/tech/materials = 4, /decl/tech/biotech = 2, /decl/tech/programming = 3) // Made of gold.
	materials = alist(/decl/material/glass = 2000, /decl/material/gold = 100, "sacid" = 20)
...
/datum/design/circuit/ai_module/freeform
	...
	req_tech = list(/decl/tech/materials = 4, /decl/tech/programming = 4) // Made of gold.
	materials = alist(/decl/material/glass = 2000, /decl/material/gold = 100, "sacid" = 20)
...
/datum/design/circuit/core_ai_module/asimov
	...
	req_tech = list(/decl/tech/materials = 6, /decl/tech/programming = 3) // Made with diamonds!
	materials = alist(/decl/material/glass = 2000, /decl/material/diamond = 100, "sacid" = 20)
...
/datum/design/circuit/core_ai_module/tyrant
	...
	req_tech = list(/decl/tech/materials = 6, /decl/tech/programming = 4, /decl/tech/syndicate = 2) // Made with diamonds!
	materials = alist(/decl/material/glass = 2000, /decl/material/diamond = 100, "sacid" = 20)
