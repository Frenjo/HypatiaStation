...
/obj/machinery/r_n_d/proc/eject_stored_materials()
	...
	if(stored_materials[MATERIAL_BANANIUM] >= 2000)
		var/obj/item/stack/sheet/bananium/G = new /obj/item/stack/sheet/bananium(src.loc)
	...
	if(stored_materials[MATERIAL_MYTHRIL] >= 2000)
		var/obj/item/stack/sheet/mythril/G = new /obj/item/stack/sheet/mythril(src.loc)
