// Chassis
/datum/construction/mecha/chassis/rescue_ranger
	steps = list(
...
/datum/construction/mecha/chassis/rescue_ranger/spawn_result()
	. = ..(/datum/construction/reversible/mecha/rescue_ranger, "ripley0")
...
/datum/construction/reversible/mecha/rescue_ranger/custom_action(index, diff, atom/used_atom, mob/user)
	if(!..())
		return FALSE
