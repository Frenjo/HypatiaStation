...
/client/proc/cmd_admin_change_custom_event()
	...
	var/input = input(usr, "Enter the description of the custom event. Be descriptive. To cancel the event, make this blank or hit cancel.", "Custom Event", global.custom_event_msg) as message | null
	if(!input || input == "")
	...
	to_world(SPAN_ALERT("[html_encode(global.custom_event_msg)]"))
	to_world("<br>")
