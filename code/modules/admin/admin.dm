...
/datum/admins/proc/Secrets()
	...
	if(check_rights(R_ADMIN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsadmin=list_signalers'>Show last [length(global.lastsignalers)] signalers</A><BR>
			<A href='?src=\ref[src];secretsadmin=list_lawchanges'>Show last [length(global.lawchanges)] law changes</A><BR>
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=electricstorm'>Spawn an Electrical Storm</A><BR>
			<BR>
			<B>Fun Secrets</B><BR>
			<BR>
		...
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=moveferry'>Move CentComm Ferry</A><BR>
			<A href='?src=\ref[src];secretsfun=movealienship'>Move Alien Dinghy</A><BR>
			<A href='?src=\ref[src];secretsfun=moveminingshuttle'>Move Mining Shuttle</A><BR>
			<A href='?src=\ref[src];secretsfun=moveresearchshuttle'>Move Research Shuttle</A><BR>
