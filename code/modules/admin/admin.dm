...
/datum/admins/proc/access_news_network() //MARKER
	...
	switch(admincaster_screen)
		...
		if(18)
			dat+={"
				<B><FONT COLOR ='maroon'>-- STATIONWIDE WANTED ISSUE --</B></FONT><BR><FONT SIZE=2>\[Submitted by: <FONT COLOR='green'>[global.CTeconomy.news_network.wanted_issue.backup_author]</FONT>\]</FONT><HR>
				<B>Criminal</B>: [global.CTeconomy.news_network.wanted_issue.author]<BR>
				<B>Description</B>: [global.CTeconomy.news_network.wanted_issue.body]<BR>
				<B>Photo:</B>:
			"}
...
/datum/admins/proc/secrets_panel()
	...
	if(check_rights(R_FUN, 0))
		...
		html += "<a href='byond://?src=\ref[src];secretsfun=immovable_rod'>Spawn an Immovable Rod</a><br>"
		html += "Spawn an Ion Storm: "
		html += "<a href='byond://?src=\ref[src];secretsfun=ion_storm'>Standard</a> | "
		...
		html += "<a href='byond://?src=\ref[src];secretsfun=electrical_storm'>Standard</a> | "
		html += "<a href='byond://?src=\ref[src];secretsfun=electrical_storm_large'>Severe</a>"
		html += "<br>"
		html += "Spawn Space Dust: "
		html += "<a href='byond://?src=\ref[src];secretsfun=space_dust;severity=weak'>Weak</a> | "
		html += "<a href='byond://?src=\ref[src];secretsfun=space_dust;severity=normal'>Normal</a> | "
...
/datum/admins/proc/announce()
	...
	if(message)
		...
		to_world("\blue <b>[usr.client.holder.fakekey ? "Administrator" : usr.key] Announces:</b<br> \t [message]")
...
/proc/is_special_character(mob/M) // returns 1 for specail characters and 2 for heroes of gamemode
	...
	if(isrobot(M))
		...
		if(R.emagged)
			return 1
	if(!isemptylist(M.mind?.special_roles)) //If they have a mind and special role, they are some type of traitor or antagonist.
		return 1
