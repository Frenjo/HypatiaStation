...
/datum/admins/proc/check_antagonists()
	if(global.CTgame_ticker && global.CTgame_ticker.current_state >= GAME_STATE_PLAYING)
		...
		dat += "Current Game Mode: <B>[global.CTgame_ticker.mode.name]</B><BR>"
		...
		if(length(global.CTgame_ticker.mode.head_revolutionaries) || length(global.CTgame_ticker.mode.revolutionaries))
			...
			for(var/datum/mind/N in global.CTgame_ticker.mode.head_revolutionaries)
				...
				if(!M)
					...
					dat += "<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td></tr>"
			for(var/datum/mind/N in global.CTgame_ticker.mode.revolutionaries)
				var/mob/M = N.current
				if(M)
					dat += "<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[M]'>[M.real_name]</a>[M.client ? "" : " <i>(logged out)</i>"][M.stat == DEAD ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
					dat += "<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td></tr>"
			dat += "</table><table cellspacing=5><tr><td><B>Target(s)</B></td><td></td><td><B>Location</B></td></tr>"
			for(var/datum/mind/N in global.CTgame_ticker.mode.get_living_heads())
				var/mob/M = N.current
				if(M)
					dat += "<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[M]'>[M.real_name]</a>[M.client ? "" : " <i>(logged out)</i>"][M.stat == DEAD ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
