// These are the only /decl types currently that are part of a module and aren't in the /code/game/decls directory.
// Debating whether or not this is a "core feature" that should be moved away from being a module.
/decl/trade_destination
	var/name = ""
	var/description = ""
	var/distance = 0 // Measured in AU and co-relates to travel time.
...
/decl/trade_destination/proc/get_custom_eventstring(event_type)
	return null

/decl/trade_destination/centcom
	name = "CentCom"
...
/decl/trade_destination/redolant
	name = "OAV Redolant"
...
/decl/trade_destination/new_gibson
	name = "New Gibson"
...
/decl/trade_destination/luthien
	name = "Luthien"
