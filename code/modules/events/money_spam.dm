		...
		if(prob(2))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(2)
					...
					"If you will write to me on my email [pick(global.first_names_female)]@[pick(global.last_names)].[pick("ru","ck","tj","ur","nt")] I shall necessarily send you a photo (QuickDating).",\
