...
/obj/item/book/manual/robotics_cyborgs
	...
	dat = {"<html>
        ...
        h3 {font-size: 15px; margin: 15px 0px 5px;}
			  ...
			  Dents in a cyborg's frame are rather easy to repair, all you need is to apply a welding torch to the dented area, and the high-tech cyborg frame will repair the dent under the heat of the welder.
...
/obj/item/book/manual/evaguide
	...
	dat = {"<html>
				...
				These suits come in Engineering, Mining, and the Armoury. There's also a couple Medical Hardsuits in EVA. These provide a lot more protection than the standard suits.<BR><BR>
