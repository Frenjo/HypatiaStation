/obj/projectile/energy/beam/laser
	name = "laser beam"
...
/obj/projectile/energy/beam/laser/heavy
...
/obj/projectile/energy/beam/laser/heavy/death
	name = "death laser beam"

	damage = 60

/obj/projectile/energy/beam/laser/practice
	damage = 0
	nodamage = TRUE
 ...
 */
/obj/projectile/energy/beam/laser/tag
	name = "lasertag beam"

	damage = 0
	nodamage = TRUE

/obj/projectile/energy/beam/laser/tag/blue
	muzzle_type = /obj/effect/projectile/laser_blue/muzzle
	tracer_type = /obj/effect/projectile/laser_blue/tracer
	impact_type = /obj/effect/projectile/laser_blue/impact

/obj/projectile/energy/beam/laser/tag/blue/on_hit(atom/target, blocked = 0)
	if(ishuman(target))
...
/obj/projectile/energy/beam/laser/tag/red
	muzzle_type = /obj/effect/projectile/laser/muzzle
	tracer_type = /obj/effect/projectile/laser/tracer
	impact_type = /obj/effect/projectile/laser/impact

/obj/projectile/energy/beam/laser/tag/red/on_hit(atom/target, blocked = 0)
	if(ishuman(target))
		var/mob/living/carbon/human/M = target
...
/obj/projectile/energy/beam/laser/tag/omni // A laser tag bolt that stuns EVERYONE
	muzzle_type = /obj/effect/projectile/laser_omni/muzzle
	tracer_type = /obj/effect/projectile/laser_omni/tracer
	impact_type = /obj/effect/projectile/laser_omni/impact

/obj/projectile/energy/beam/laser/tag/omni/on_hit(atom/target, blocked = 0)
	if(ishuman(target))
		var/mob/living/carbon/human/M = target
