...
/datum/chemical_reaction/slimespawn
	name = "Slime Spawn"
	required_reagents = alist(/datum/reagent/plasma = 5)
	result_amount = 1
...
/datum/chemical_reaction/slimemonkey
	name = "Slime Monkey"
	required_reagents = alist(/datum/reagent/blood = 5)
	result_amount = 1
	required_container = /obj/item/slime_extract/grey
	required_other = 1
...
/datum/chemical_reaction/slimeglow
	name = "Slime Glow"
	required_reagents = alist(/datum/reagent/water = 5)
	result_amount = 1
	required_container = /obj/item/slime_extract/yellow
	required_other = 1
...
/datum/chemical_reaction/slimejam
	...
	required_reagents = alist(/datum/reagent/sugar = 5)
	result_amount = 10
	required_container = /obj/item/slime_extract/purple
	required_other = 1
...
/datum/chemical_reaction/slimemutate2
	...
	result = /datum/reagent/toxin/amatoxin
	required_reagents = alist(/datum/reagent/plasma = 5)
	result_amount = 1
	required_other = 1
...
/datum/chemical_reaction/slimepepper
	...
	required_reagents = alist(/datum/reagent/sugar = 1)
	result_amount = 1
...
/datum/chemical_reaction/slimefrost
	name = "Slime Frost Oil"
	result = /datum/reagent/frostoil
	required_reagents = alist(/datum/reagent/water = 1)
	result_amount = 1
	required_container = /obj/item/slime_core
	required_other = 1
...
/datum/chemical_reaction/slimeglycerol
	name = "Slime Glycerol"
	result = /datum/reagent/glycerol
	required_reagents = alist(/datum/reagent/blood = 1)
	result_amount = 1
	required_container = /obj/item/slime_core
	required_other = 1
...
/datum/chemical_reaction/slimeenzyme
	...
	required_reagents = alist(/datum/reagent/blood = 1, /datum/reagent/water = 1)
	result_amount = 2
	required_container = /obj/item/slime_core
	required_other = 3
...
/datum/chemical_reaction/slimeplasma
	name = "Slime Plasma"
	result = /datum/reagent/plasma
	required_reagents = alist(/datum/reagent/blood = 2, /datum/reagent/sugar = 1)
	result_amount = 2
	required_container = /obj/item/slime_core
	required_other = 3
...
/datum/chemical_reaction/slimevirus
	name = "Slime Virus"
	required_reagents = alist(/datum/reagent/sugar = 1, /datum/reagent/toxin/acid = 1)
	result_amount = 2
	required_container = /obj/item/slime_core
	required_other = 3
...
/datum/chemical_reaction/slimeteleport
	name = "Slime Teleport"
	required_reagents = alist("pacid" = 2, "mutagen" = 2)
	required_catalysts = list(/datum/reagent/plasma = 1)
	result_amount = 1
	required_container = /obj/item/slime_core
	required_other = 4
...
/datum/chemical_reaction/slimecrit
	name = "Slime Crit"
	required_reagents = alist(/datum/reagent/blood = 1, /datum/reagent/toxin/acid = 1)
	required_catalysts = list(/datum/reagent/plasma = 1)
	result_amount = 1
	required_container = /obj/item/slime_core
	required_other = 4
...
/datum/chemical_reaction/slimechloral
	...
	required_reagents = alist(/datum/reagent/blood = 1, /datum/reagent/water = 2)
	result_amount = 2
	required_container = /obj/item/slime_core
	required_other = 5
...
/datum/chemical_reaction/slimefoam
	name = "Slime Foam"
	required_reagents = alist(/datum/reagent/toxin/acid = 1)
	result_amount = 2
	required_container = /obj/item/slime_core
	required_other = 5
