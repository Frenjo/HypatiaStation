...
obj/machinery/nanosprayer/attack_hand(user as mob)
	...
	dat += text("\[<A href='byond:://?src=\ref[src];minus=1'>-</A> / <A href='byond:://?src=\ref[src];plus=1'>+</A>\]<BR>")
	if(payload)
	...
	if(state == 2)
		...
		dat += text("\[<A href='byond:://?src=\ref[src];release=1'>Release Payload</A>\]<BR>")
	dat += text("<HR><BR><A href='byond:://?src=\ref[src];settask=1'>Set Task</A><BR>")
