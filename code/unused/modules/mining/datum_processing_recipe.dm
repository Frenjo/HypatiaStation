...
var/list/datum/material_recipe/MATERIAL_RECIPES = list(
		...
		new/datum/material_recipe("Diamond", list(/obj/item/ore/diamond), /obj/item/stack/sheet/diamond),
		new/datum/material_recipe("Plasma", list(/obj/item/ore/plasma), /obj/item/stack/sheet/plasma),
		new/datum/material_recipe("Bananium", list(/obj/item/ore/clown), /obj/item/stack/sheet/clown),
	)