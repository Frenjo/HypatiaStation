...
/datum/game_mode/deathmatch
	...
	announce()
		to_world("<B>The current game mode is - Death Commando Deathmatch!</B>")
		to_world("<B>Just kill everyone else. They're gonna try to kill you, after all. Respawning is enabled.</B>")
