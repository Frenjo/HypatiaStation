/datum/hud_data
	...
	var/list/gear = list(
		"i_clothing" =		list("loc" = UI_ICLOTHING,	"slot" = SLOT_ID_WEAR_UNIFORM,	"state" = "center",		"toggle" = TRUE,	"dir" = SOUTH),
		"o_clothing" =		list("loc" = UI_OCLOTHING,	"slot" = SLOT_ID_WEAR_SUIT,		"state" = "equip",		"toggle" = TRUE,	"dir" = SOUTH),
		"mask" =			list("loc" = UI_MASK,		"slot" = SLOT_ID_WEAR_MASK,		"state" = "equip",		"toggle" = TRUE,	"dir" = NORTH),
		"gloves" =			list("loc" = UI_GLOVES,		"slot" = SLOT_ID_GLOVES,		"state" = "gloves",		"toggle" = TRUE),
		"eyes" =			list("loc" = UI_GLASSES,	"slot" = SLOT_ID_GLASSES,		"state" = "glasses",	"toggle" = TRUE),
		"l_ear" =			list("loc" = UI_L_EAR,		"slot" = SLOT_ID_L_EAR,			"state" = "ears",		"toggle" = TRUE),
		"r_ear" =			list("loc" = UI_R_EAR,		"slot" = SLOT_ID_R_EAR,			"state" = "ears",		"toggle" = TRUE),
		"head" =			list("loc" = UI_HEAD,		"slot" = SLOT_ID_HEAD,			"state" = "hair",		"toggle" = TRUE),
		"shoes" =			list("loc" = UI_SHOES,		"slot" = SLOT_ID_SHOES,			"state" = "shoes",		"toggle" = TRUE),
		"suit storage" =	list("loc" = UI_SSTORE1,	"slot" = SLOT_ID_SUIT_STORE,	"state" = "belt",		"toggle" = TRUE,	"dir" = WEST),
