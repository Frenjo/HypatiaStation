...
/datum/species/soghun
	...
	species_flags = SPECIES_FLAG_HAS_SKIN_COLOUR | SPECIES_FLAG_HAS_EYE_COLOUR | SPECIES_FLAG_HAS_LIPS | SPECIES_FLAG_HAS_UNDERWEAR \
		| SPECIES_FLAG_HAS_TAIL | SPECIES_FLAG_IS_WHITELISTED
