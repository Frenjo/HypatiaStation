...
/mob/living/carbon/human/proc/handle_breath(datum/gas_mixture/breath)
	...
	if(breath.gas[/decl/xgm_gas/nitrous_oxide])
		...
		breath.adjust_gas(/decl/xgm_gas/nitrous_oxide, -breath.gas[/decl/xgm_gas/nitrous_oxide])
...
/mob/living/carbon/human/proc/handle_regular_hud_updates()
	...
	if(stat == UNCONSCIOUS)
		...
		if(health <= 0)
			...
			switch(health)
				if(-20 to -10)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage1")
				if(-30 to -20)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage2")
				if(-40 to -30)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage3")
				if(-50 to -40)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage4")
				if(-60 to -50)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage5")
				if(-70 to -60)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage6")
				if(-80 to -70)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage7")
				if(-90 to -80)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "passage8")
				if(-95 to -90)
		...
		if(oxyloss)
			...
			switch(oxyloss)
				if(10 to 20)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "oxydamageoverlay1")
				if(20 to 25)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "oxydamageoverlay2")
				if(25 to 30)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "oxydamageoverlay3")
				if(30 to 35)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "oxydamageoverlay4")
				if(35 to 40)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "oxydamageoverlay5")
				if(40 to 45)
		...
		if(hurtdamage)
			...
			switch(hurtdamage)
				if(10 to 25)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "brutedamageoverlay1")
				if(25 to 40)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "brutedamageoverlay2")
				if(40 to 55)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "brutedamageoverlay3")
				if(55 to 70)
					I = image("icon" = 'icons/hud/screen1_full.dmi', "icon_state" = "brutedamageoverlay4")
				if(70 to 85)
...
/mob/living/carbon/human/proc/handle_hud_list()
	...
	if(BITTEST(hud_updateflag, IMPTRACK_HUD) || BITTEST(hud_updateflag, IMPSHIELD_HUD) \
	|| BITTEST(hud_updateflag, IMPLOYAL_HUD) || BITTEST(hud_updateflag, IMPCHEM_HUD))
		var/image/holder1 = hud_list[IMPTRACK_HUD]
		var/image/holder2 = hud_list[IMPSHIELD_HUD]
		var/image/holder3 = hud_list[IMPLOYAL_HUD]
		var/image/holder4 = hud_list[IMPCHEM_HUD]
		...
		for(var/obj/item/implant/I in src)
			if(I.implanted)
				...
				if(istype(I, /obj/item/implant/loyalty))
					holder3.icon_state = "hud_imp_loyal"
				if(istype(I, /obj/item/implant/chem))
					holder4.icon_state = "hud_imp_chem"

		hud_list[IMPTRACK_HUD] = holder1
		hud_list[IMPSHIELD_HUD] = holder2
		hud_list[IMPLOYAL_HUD] = holder3
		hud_list[IMPCHEM_HUD] = holder4
