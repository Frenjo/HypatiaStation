...
/mob/living/simple/hostile/giant_spider
	name = "giant spider"
...
/mob/living/simple/hostile/giant_spider/nurse
	...
	poison_type = "soporific"
	var/fed = 0

//hunters have the most poison and move the fastest, so they can find prey
/mob/living/simple/hostile/giant_spider/hunter
...
/mob/living/simple/hostile/giant_spider/AttackingTarget()
	..()
	if(isliving(target))
...
/mob/living/simple/hostile/giant_spider/nurse/proc/GiveUp(var/C)
	spawn(100)
...
/mob/living/simple/hostile/giant_spider/nurse/Life()
	..()
	if(!stat)
		if(stance == HOSTILE_STANCE_IDLE)
						...
						if(busy == SPINNING_COCOON)
							if(cocoon_target && isturf(cocoon_target.loc) && get_dist(src,cocoon_target) <= 1)
								...
								for(var/mob/living/M in C.loc)
									if(istype(M, /mob/living/simple/hostile/giant_spider))
										continue
									large_cocoon = 1
									fed++
