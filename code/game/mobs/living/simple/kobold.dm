...
/mob/living/simple/kobold
	...
	turns_per_move = 5
	see_in_dark = 6
	meat_type = /obj/item/reagent_holder/food/snacks/meat/slab/monkey
...
/mob/living/simple/kobold/Life()
	..()
	if(prob(15) && turns_since_move && !stat)
		flick("kobold_act",src)

/mob/living/simple/kobold/Move(var/dir)
	..()
	if(!stat)
