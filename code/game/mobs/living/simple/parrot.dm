...
/mob/living/simple/parrot
	...
	turns_per_move = 5
	meat_type = /obj/item/reagent_holder/food/snacks/cracker/
	...
	var/obj/desired_perches = list(/obj/structure/computerframe, 		/obj/structure/displaycase, \
									/obj/structure/filingcabinet,		/obj/machinery/teleporter, \
									/obj/machinery/computer,			/obj/machinery/clonepod, \
									/obj/machinery/dna_scannernew,		/obj/machinery/telecoms, \
...
/mob/living/simple/parrot/New()
	...
	verbs.Add(/mob/living/simple/parrot/proc/steal_from_ground, \
			  /mob/living/simple/parrot/proc/steal_from_mob, \
			  /mob/living/simple/parrot/verb/drop_held_item_player, \
			  /mob/living/simple/parrot/proc/perch_player)


/mob/living/simple/parrot/Die()
	if(held_item)
 ...
 * Inventory
 */
/mob/living/simple/parrot/show_inv(mob/user)
...
/mob/living/simple/parrot/Topic(href, href_list)
...
/mob/living/simple/parrot/attack_paw(mob/living/carbon/monkey/M)
	attack_hand(M)

//Simple animals
/mob/living/simple/parrot/attack_animal(mob/living/simple/M)
	if(client) return
...
/mob/living/simple/parrot/movement_delay() // This needs to be refactored as it's completely different to all others.
	if(isnotnull(client) && stat == CONSCIOUS && parrot_state != "parrot_fly")
		icon_state = "parrot_fly"
	. = ..()

/mob/living/simple/parrot/proc/search_for_item()
...
/mob/living/simple/parrot/proc/search_for_perch()
...
/mob/living/simple/parrot/proc/search_for_perch_and_item()
	for(var/atom/movable/AM in view(src))
 ...
 */
/mob/living/simple/parrot/proc/steal_from_ground()
...
/mob/living/simple/parrot/proc/drop_held_item(var/drop_gently = 1)
	set name = "Drop held item"
	set category = "Parrot"
	set desc = "Drop the item you're holding."
...
/mob/living/simple/parrot/Poly/New()
