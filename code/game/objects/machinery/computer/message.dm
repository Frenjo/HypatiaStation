					...
					if("Send")
						...
						if(isnull(PDARec))
							...
							if(!customrecepient.silent)
								...
								for (var/mob/O in hearers(3, customrecepient.loc))
									O.show_message("[html_icon(customrecepient)] *[customrecepient.ttone]*")
								if(customrecepient.loc && ishuman(customrecepient.loc))
									var/mob/living/carbon/human/H = customrecepient.loc
									to_chat(H, "[html_icon(customrecepient)] <b>Message from [customsender] ([customjob]), </b>\"[custommessage]\" (<a href='byond://?src=\ref[src];choice=Message;skiprefresh=1;target=\ref[src]'>Reply</a>)")
						...
						//Sender is faking as someone who exists
							...
							if(!customrecepient.silent)
								...
								if(customrecepient.loc && ishuman(customrecepient.loc))
									var/mob/living/carbon/human/H = customrecepient.loc
									to_chat(H, "[html_icon(customrecepient)] <b>Message from [PDARec.owner] ([customjob]), </b>\"[custommessage]\" (<a href='byond://?src=\ref[customrecepient];choice=Message;skiprefresh=1;target=\ref[PDARec]'>Reply</a>)")
