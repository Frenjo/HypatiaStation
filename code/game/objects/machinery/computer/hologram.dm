...
/obj/machinery/computer/hologram_comp/proc/render()
	...
	var/icon/U = new /icon('icons/mob/on_mob/human_face.dmi', "hair_a_s")
...
/obj/machinery/computer/hologram_comp/proc/show_console(mob/user)
	...
	if (src.temp)
		dat = text("[]<BR><BR><A href='byond://?src=\ref[];temp=1'>Clear</A>", src.temp, src)
	else
		dat = text("<B>Hologram Status:</B><HR>\nPower: <A href='byond://?src=\ref[];power=1'>[]</A><HR>\n<B>Hologram Control:</B><BR>\nColor Luminosity: []/220 <A href='byond://?src=\ref[];reset=1'>\[Reset\]</A><BR>\nLighten: <A href='byond://?src=\ref[];light=1'>1</A> <A href='byond://?src=\ref[];light=10'>10</A><BR>\nDarken: <A href='byond://?src=\ref[];light=-1'>1</A> <A href='byond://?src=\ref[];light=-10'>10</A><BR>\n<BR>\nHair Color: ([],[],[]) <A href='byond://?src=\ref[];h_reset=1'>\[Reset\]</A><BR>\nRed (0-255): <A href='byond://?src=\ref[];h_r=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_r=-10'>-10</A> <A href='byond://?src=\ref[];h_r=-1'>-1</A> [] <A href='byond://?src=\ref[];h_r=1'>1</A> <A href='byond://?src=\ref[];h_r=10'>10</A> <A href='byond://?src=\ref[];h_r=300'>\[255\]</A><BR>\nGreen (0-255): <A href='byond://?src=\ref[];h_g=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_g=-10'>-10</A> <A href='byond://?src=\ref[];h_g=-1'>-1</A> [] <A href='byond://?src=\ref[];h_g=1'>1</A> <A href='byond://?src=\ref[];h_g=10'>10</A> <A href='byond://?src=\ref[];h_g=300'>\[255\]</A><BR>\nBlue (0-255): <A href='byond://?src=\ref[];h_b=-300'>\[0\]</A> <A href='byond://?src=\ref[];h_b=-10'>-10</A> <A href='byond://?src=\ref[];h_b=-1'>-1</A> [] <A href='byond://?src=\ref[];h_b=1'>1</A> <A href='byond://?src=\ref[];h_b=10'>10</A> <A href='byond://?src=\ref[];h_b=300'>\[255\]</A><BR>", src, (src.projector.hologram ? "On" : "Off"),  -src.lumens + 35, src, src, src, src, src, src.h_r, src.h_g, src.h_b, src, src, src, src, src.h_r, src, src, src, src, src, src, src.h_g, src, src, src, src, src, src, src.h_b, src, src, src)
