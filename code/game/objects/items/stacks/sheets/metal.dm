...
// Steel
GLOBAL_GLOBL_LIST_INIT(steel_recipes, list(
...
// Plasteel
GLOBAL_GLOBL_LIST_INIT(plasteel_recipes, list(
...
// Silver
GLOBAL_GLOBL_LIST_INIT(silver_recipes, list(
...
// Gold
GLOBAL_GLOBL_LIST_INIT(gold_recipes, list(
...
// Uranium
GLOBAL_GLOBL_LIST_INIT(uranium_recipes, list(
