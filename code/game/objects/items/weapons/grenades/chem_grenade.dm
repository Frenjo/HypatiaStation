...
/obj/item/grenade/chem_grenade/attackby(obj/item/weapon/W as obj, mob/user as mob)
...
/obj/item/grenade/chem_grenade/examine()
	set src in usr
	usr << desc
	if(detonator)
...
/obj/item/grenade/chem_grenade/large/New()
	..()
