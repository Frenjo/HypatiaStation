...
/datum/sprite_accessory/hair
	icon = 'icons/mob/on_mob/Human_face.dmi'		// default icon for all hairs

/datum/sprite_accessory/hair/bald
	name = "Bald"
	icon_state = "bald"
	gender = MALE
	species_allowed = list(SPECIES_HUMAN, SPECIES_SOGHUN)
...
/datum/sprite_accessory/facial_hair
	icon = 'icons/mob/on_mob/human_face.dmi'
...
/datum/sprite_accessory/hair/una_spines_long
	...
	species_allowed = list(SPECIES_SOGHUN)
