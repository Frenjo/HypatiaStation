...
/datum/game_mode/malfunction/get_announce_content()
	. = list()
	. += "<B>The current game mode is - AI Malfunction!</B>"
	. += "<B>The AI on the satellite has malfunctioned and must be destroyed.</B>"
