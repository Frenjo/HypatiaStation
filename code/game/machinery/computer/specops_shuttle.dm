...
//		announcer.autosay(message, "A.L.I.C.E.", "Response Team")
	...
	for(var/turf/T in get_area_turfs(end_location) )
		var/mob/M = locate(/mob) in T
		M << "\red You have arrived to [global.station_name]. Commence operation!"
...
//		return
	...
	if (temp)
		...
		\nLocation: [specops_shuttle_moving_to_station || specops_shuttle_moving_to_centcom ? "Departing for [global.station_name] in ([specops_shuttle_timeleft] seconds.)":specops_shuttle_at_station ? "Station":"Dock"]<BR>
		[specops_shuttle_moving_to_station || specops_shuttle_moving_to_centcom ? "\n*The Special Ops. shuttle is already leaving.*<BR>\n<BR>":specops_shuttle_at_station ? "\n<A href='?src=\ref[src];sendtodock=1'>Shuttle standing by...</A><BR>\n<BR>":"\n<A href='?src=\ref[src];sendtostation=1'>Depart to [global.station_name]</A><BR>\n<BR>"]
...
/obj/machinery/computer/specops_shuttle/Topic(href, href_list)
	...
	if (href_list["sendtodock"])
		...
		usr << "\blue The Special Operations shuttle will arrive on [global.station_name] in [(SPECOPS_MOVETIME/10)] seconds."
