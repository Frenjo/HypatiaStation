/turf/open
	...
	// A list of all gas amounts that this turf starts with, indexed by typepath.
	var/list/initial_gases = list(/decl/xgm_gas/oxygen = MOLES_O2STANDARD, /decl/xgm_gas/nitrogen = MOLES_N2STANDARD)
