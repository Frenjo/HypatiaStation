/datum/preferences/proc/ui_preferences_panel(mob/user)
	...
	var/datum/browser/panel = new /datum/browser(user, "uipreferences", "", 300, 380)
	panel.set_content(html)
	panel.open()

/datum/preferences/proc/process_ui_preferences_panel(mob/user, datum/topic_input/topic)
