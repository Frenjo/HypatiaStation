...
/datum/teleport
	...
	//optional
	proc/setEffects(datum/effect/system/aeffectin = null, datum/effect/system/aeffectout = null)
...
/datum/teleport/instant/science
	...
	setEffects(datum/effect/system/aeffectin,datum/effect/system/aeffectout)
