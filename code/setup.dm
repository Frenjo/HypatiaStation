...
//depenging helpers
var/list/DEPT_FREQS = list(FREQUENCY_SCIENCE, FREQUENCY_MEDICAL, FREQUENCY_ENGINEERING, FREQUENCY_SECURITY, FREQUENCY_SYNDICATE, FREQUENCY_RESPONSETEAM, FREQUENCY_DEATHSQUAD, FREQUENCY_SUPPLY, FREQUENCY_MINING)