...
/turf/return_air()
	...
	GM.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "plasma", toxins)
...
/turf/remove_air(amount as num)
	...
	if(sum>0)
		...
		GM.gas["plasma"] = (toxins/sum)*amount
...
/turf/proc/make_air()
	...
	air.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "plasma", toxins)
