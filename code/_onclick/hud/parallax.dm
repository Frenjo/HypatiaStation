GLOBAL_GLOBL_LIST_TYPED_NEW(parallax_stars, /atom/movable/space_star/space)
GLOBAL_GLOBL_LIST_TYPED_NEW(parallax_bluespace_stars, /atom/movable/space_star/bluespace)
