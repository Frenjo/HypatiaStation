...
/datum/hud/brain/setup(ui_style = 'icons/hud/screen1_Midnight.dmi')
	var/mob/living/brain/B = owner

	B.blind = new /atom/movable/screen()
	B.blind.icon = 'icons/hud/screen1_full.dmi'
...
/datum/hud/blob/setup(ui_style = 'icons/hud/screen1_Midnight.dmi')
