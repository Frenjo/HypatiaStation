/datum/hud/alien/setup()
	...
	adding.Add(
		new /atom/movable/screen/action_intent/help(src, 'icons/hud/screen1_alien.dmi'),
		new /atom/movable/screen/action_intent/disarm(src, 'icons/hud/screen1_alien.dmi'),
		new /atom/movable/screen/action_intent/grab(src, 'icons/hud/screen1_alien.dmi'),
		new /atom/movable/screen/action_intent/harm(src, 'icons/hud/screen1_alien.dmi')
	)
	...
	adding.Add(new /atom/movable/screen/action/drop('icons/hud/screen1_alien.dmi', UI_DROP_THROW))
...
//equippable shit
	...
	inv_box.icon = 'icons/hud/screen1_alien.dmi'
...
/*
	adding.Add(new /atom/movable/screen/action/resist('icons/hud/screen1_alien.dmi', UI_RESIST))
*/

	owner.throw_icon = new /atom/movable/screen/action/throw_icon('icons/hud/screen1_alien.dmi', UI_DROP_THROW)
