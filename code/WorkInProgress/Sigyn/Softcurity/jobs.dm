/datum/job/hos
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/administrator(H), SLOT_ID_WEAR_UNIFORM)
...
/datum/job/warden
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/storage/satchel_sec(H), SLOT_ID_BACK)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/advisor(H), SLOT_ID_WEAR_UNIFORM)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/boots(H), SLOT_ID_SHOES)
		H.equip_to_slot_or_del(new /obj/item/pda/warden(H), SLOT_ID_BELT)
		H.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses(H), SLOT_ID_GLASSES)
		H.equip_to_slot_or_del(new /obj/item/flash(H), SLOT_ID_L_POCKET)
		H.equip_to_slot_or_del(new /obj/item/storage/box/survival(H.back), SLOT_ID_IN_BACKPACK)
		H.equip_to_slot_or_del(new /obj/item/handcuffs(H), SLOT_ID_IN_BACKPACK)
		var/obj/item/implant/loyalty/L = new/obj/item/implant/loyalty(H)
		L.imp_in = H
...
/datum/job/detective
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/under/det(H), SLOT_ID_WEAR_UNIFORM)
		...
		H.equip_to_slot_or_del(new /obj/item/lighter/zippo(H), SLOT_ID_L_POCKET)
...
/datum/job/officer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/radio/headset/headset_sec(H), slot_ears)
		H.equip_to_slot_or_del(new /obj/item/storage/satchel_sec(H), SLOT_ID_BACK)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/supervisor(H), SLOT_ID_WEAR_UNIFORM)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/boots(H), SLOT_ID_SHOES)
		H.equip_to_slot_or_del(new /obj/item/pda/security(H), SLOT_ID_BELT)
		H.equip_to_slot_or_del(new /obj/item/handcuffs(H), SLOT_ID_R_POCKET)
		H.equip_to_slot_or_del(new /obj/item/flash(H), SLOT_ID_L_POCKET)
		H.equip_to_slot_or_del(new /obj/item/storage/box/survival(H.back), SLOT_ID_IN_BACKPACK)
		H.equip_to_slot_or_del(new /obj/item/handcuffs(H), SLOT_ID_IN_BACKPACK)
		var/obj/item/implant/loyalty/L = new/obj/item/implant/loyalty(H)
...
/datum/job/hop
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/storage/box/survival(H.back), SLOT_ID_IN_BACKPACK)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/head_of_personnel(H), SLOT_ID_WEAR_UNIFORM)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/brown(H), SLOT_ID_SHOES)
