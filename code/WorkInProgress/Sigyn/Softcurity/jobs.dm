/datum/job/hos
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/satchel_sec(H), SLOT_ID_BACK)
		...
		H.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/taser(H), SLOT_ID_S_STORE)
...
/datum/job/detective
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_sec(H), slot_ears)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/satchel_norm(H), SLOT_ID_BACK)
...
/datum/job/officer
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/weapon/handcuffs(H), SLOT_ID_R_STORE)
		H.equip_to_slot_or_del(new /obj/item/device/flash(H), SLOT_ID_L_STORE)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), SLOT_ID_IN_BACKPACK)
		H.equip_to_slot_or_del(new /obj/item/weapon/handcuffs(H), SLOT_ID_IN_BACKPACK)
		var/obj/item/weapon/implant/loyalty/L = new/obj/item/weapon/implant/loyalty(H)
...
/datum/job/hop
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 2) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(H), SLOT_ID_BACK)
		if(H.backbag == 3) H.equip_to_slot_or_del(new /obj/item/weapon/storage/satchel_norm(H), SLOT_ID_BACK)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), SLOT_ID_IN_BACKPACK)
		...
		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/id_kit(H), SLOT_ID_R_HAND)
		else
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/id_kit(H.back), SLOT_ID_IN_BACKPACK)
		return 1
