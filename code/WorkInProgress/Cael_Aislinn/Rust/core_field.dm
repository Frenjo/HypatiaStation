...
/obj/effect/rust_em_field/process()
	...
	if(held_plasma.gas[/decl/xgm_gas/plasma] < transfer_ratio * 1000)
		...
		//
		gas_covered.adjust_gas(/decl/xgm_gas/plasma, -plasma_captured.gas[/decl/xgm_gas/plasma])
		//
	...
	//SPECIFIC_HEAT_TOXIN
	if(mega_energy > 0 && held_plasma.gas[/decl/xgm_gas/plasma])
	...
	if(held_plasma.gas[/decl/xgm_gas/plasma] > 1)
		...
		//
		plasma_lost.gas[/decl/xgm_gas/plasma] = held_plasma.gas[/decl/xgm_gas/plasma] * loss_ratio
		//plasma_lost.update_values()
		held_plasma.gas[/decl/xgm_gas/plasma] -= held_plasma.gas[/decl/xgm_gas/plasma] * loss_ratio
		...
		held_plasma.gas[/decl/xgm_gas/plasma] = null
		//held_plasma.update_values()
