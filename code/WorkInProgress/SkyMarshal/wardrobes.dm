...
/obj/item/wardrobe
	...
	attackby(var/obj/item/I as obj, var/mob/user as mob)
		if(istype(I, /obj/item/wardrobe) || istype(I, /obj/item/evidencebag))
			return
		if(contents.len < 20)
...
/obj/item/wardrobe/engineer
	...
	New()
		...
		new /obj/item/storage/box(BPK)
		new /obj/item/pen(src)
		new /obj/item/pda/engineering(src)
...
/obj/item/wardrobe/hop
	...
	New()
		...
		new /obj/item/pda/heads/hop(src)
		new /obj/item/storage/id_kit(src)
		new /obj/item/flash(src)
		new /obj/item/clothing/glasses/sunglasses(src)
...
/obj/item/wardrobe/cmo
	...
	New()
		..()
		var/obj/item/storage/backpack/medic/BPK = new /obj/item/storage/backpack/medic(src)
		new /obj/item/storage/box(BPK)
		new /obj/item/pen(src)
		new /obj/item/pda/heads/cmo(src)
...
/obj/item/wardrobe/hos
	...
	New()
		..()
		var/obj/item/storage/backpack/security/BPK = new /obj/item/storage/backpack/security(src)
		new /obj/item/storage/box(BPK)
		new /obj/item/pen(src)
		new /obj/item/melee/baton(src)
		new /obj/item/gun/energy/gun(src)
		new /obj/item/flash(src)
		new /obj/item/pda/heads/hos(src)
...
/obj/item/wardrobe/detective
	...
	New()
		...
		new /obj/item/clipboard(src)
		new /obj/item/clipboard/notebook(src)
		new /obj/item/detective_scanner(src)
		new /obj/item/taperoll/police(src)
		new /obj/item/storage/box/evidence(src)
		new /obj/item/pda/detective(src)
...
/obj/item/wardrobe/qm
	...
	New()
		...
		new /obj/item/pen(src)
		new /obj/item/clipboard(src)
		new /obj/item/pda/quartermaster(src)
		new /obj/item/clothing/glasses/sunglasses(src)
...
/obj/item/wardrobe/mining
	...
	New()
		...
		new /obj/item/clothing/glasses/meson(src)
		new /obj/item/radio/headset/headset_mine(src)
		new /obj/item/clothing/shoes/black(src)
...
/obj/item/wardrobe/janitor
	...
	New()
		...
		new /obj/item/storage/box(BPK)
		new /obj/item/pen(src)
		new /obj/item/pda/janitor(src)
		new /obj/item/clothing/shoes/black(src)
		new /obj/item/clothing/under/rank/janitor(src)
		new /obj/item/portalathe(src)
