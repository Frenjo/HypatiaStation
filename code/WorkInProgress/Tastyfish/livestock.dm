...
/mob/living/simple/livestock
	...
	speak_chance = 1
	turns_per_move = 15
	meat_type = /obj/item/reagent_holder/food/snacks/sliceable/meat
	response_help  = "pets"
			...
			if(nutrition_step <= 0)
				...
				if(movement_target)
					...
					if(isturf(movement_target.loc))
						...
						if(istype(movement_target, /obj/item/reagent_holder/food/snacks))
...
/mob/living/simple/livestock/cow
	...
	icon_living = "cow"
	icon_dead = "cow_d"
	meat_type = /obj/item/reagent_holder/food/snacks/sliceable/meat/cow
	meat_amount = 10
	max_nutrition = 1000
...
/mob/living/simple/livestock/chicken
	...
	icon_living = "chick"
	icon_dead = "chick_d"
	meat_type = /obj/item/reagent_holder/food/snacks/sliceable/meat/chicken
	meat_amount = 3
	max_nutrition = 200
...
/mob/living/simple/livestock/chicken/Life()
	...
	if(stat != DEAD && nutrition_step == 1 && nutrition > max_nutrition / 2)
		...
		if(prob(33))
			new/obj/item/reagent_holder/food/snacks/egg(src.loc) // lay an egg
			nutrition -= 25

/obj/item/reagent_holder/food/snacks/sliceable/meat/chicken
	name = "Chicken"
	desc = "Tasty!"
