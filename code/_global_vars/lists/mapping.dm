...
// Areas
GLOBAL_GLOBL_LIST_TYPED_NEW(area_list, /area) // A list of all areas in the world.
GLOBAL_GLOBL_LIST_TYPED_NEW(open_turf_list, /turf/open) // A list of all open turfs in the world.
GLOBAL_GLOBL_LIST_TYPED_NEW(closed_turf_list, /turf/closed) // A list of all closed turfs in the world.

// Landmarks
GLOBAL_GLOBL_LIST_TYPED_NEW(landmark_list, /obj/effect/landmark) // A list of all created landmarks.
