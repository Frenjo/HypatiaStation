// These are all styled in the same way as _std/core.dm as they're intended to look like part of the language.
...
#define isfloorturf(X) istype(X, /turf/open/floor)
